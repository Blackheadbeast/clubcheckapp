    ...
    <div className="min-h-screen bg-[#0a0a0a] overflow-x-hidden">
      ...
      <section className="pt-24 pb-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 mt-12 text-xs text-gray-500">
            <span>Payments via Stripe (PCI-DSS)</span>
      ...
      {/* FEATURES */}
      <section id="features" className="py-20 px-4 bg-[#0d0d0d]">
        <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="p-6 rounded-lg border border-primary/50 bg-[#111] relative">
              ...
              <div className="mb-6">
                <span className="text-4xl font-bold text-gray-100">$99.99</span>
                <span className="text-gray-500 text-sm">/month</span>
              </div>
              <ul className="space-y-2.5 mb-6">
                {[
          ...
          <p className="text-center text-gray-500 text-xs mt-8">
            Save ~$200/year with annual billing. All payments processed by Stripe.
          </p>
        </div>
      </section>
